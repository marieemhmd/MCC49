                ...
                return this.each(function () {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("min") !== undefined || $this.attr("aria-valuemin") !== undefined) {
                            ...
                            message = "Minimum of '" + min + "'<!-- data-validation-min-message to override -->";
                        ...
                        if ($this.attr("maxlength") !== undefined) {
                            message = "Maximum of '" + $this.attr("maxlength") + "' characters<!-- data-validation-maxlength-message to override -->";
                        ...
                        if ($this.attr("minlength") !== undefined) {
                            message = "Minimum of '" + $this.attr("minlength") + "' characters<!-- data-validation-minlength-message to override -->";
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Invalid email address<!-- data-validation-email-message to override -->";
        ...
        , validatorTypes: {
            ...
            , max: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Maximum of '" + result.max + "'";
                    if ($this.data("validation" + name + "Message")) {
            ...
            , min: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Minimum of '" + result.min + "'";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , maxlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Maximum of '" + result.maxlength + "' characters";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , minlength: {
                ...
                , init: function ($this, name) {
                    ...
                    result.message = "Minimum of '" + result.minlength + "' characters";
                    if ($this.data("validation" + name + "Message")) {
                        result.message = $this.data("validation" + name + "Message");
                    }
                    return result;
            ...
            , maxchecked: {
                ...
                , init: function ($this, name) {
                    ...
                    var message = "Max '" + result.maxchecked + "' checked";
                    if ($this.data("validation" + name + "Message")) {
                        message = $this.data("validation" + name + "Message");
                    }
                    result.message = message;
